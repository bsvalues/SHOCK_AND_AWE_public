    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 text-white p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-xl text-slate-300">Hurricane-Ready • Tourism-Aware • Multilingual • Future-Proof</p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <ul className="text-sm text-slate-300 space-y-1">
                        ...
                        <li>• Identify vulnerable parcels</li>
                        <li>• Notify property owners</li>
                        <li>• Coordinate with EOC</li>
                      </ul>
                    </div>
                    <div className="space-y-2">
                      ...
                      <ul className="text-sm text-slate-300 space-y-1">
                        ...
                        <li>• Insurance claim expediting</li>
                      </ul>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <ul className="text-sm text-slate-300 space-y-1">
                        ...
                        <li>• Sea level rise projections (30-year)</li>
                        <li>• Turtle nesting season compliance</li>
                        <li>• Dune preservation impact</li>
                      </ul>
                    </div>
                    <div className="space-y-2">
                      ...
                      <ul className="text-sm text-slate-300 space-y-1">
                        ...
                        <li>• Ocean view value assessment</li>
                        <li>• Storm surge risk discount</li>
                        <li>• Insurance cost integration</li>
                      </ul>
                    </div>
                  </div>
                </div>
